...
{
    /// <summary>
    /// DispatchDirectoryUsageTest
    /// </summary>
    [TestClass]
    public class DispatchDirectoryUsageTest
    {
        /// <summary>テスト結果格納先のルートフォルダ</summary>
        private static readonly string TestResultRootDir = string.Format(@"TestResult.{0:yyyyMMddHHmmss}\{1}", DateTime.Now, nameof(DispatchController.DispatchDirectoryUsage));
        ...
        private static readonly string FailureBlobReplacePath = @"\ms-026\";
        ...
        [DataTestMethod]
        [CsvDataSourece(@"TestCases\DispatchController_DispatchDirectoryUsage.csv")]
