...
{
    /// <summary>
    /// MT_EQUIPMENT_TYPEテーブルのリポジトリ
    /// </summary>
    public partial class MtEquipmentTypeRepository : IMtEquipmentTypeRepository
    {
        /// <summary>ロガー</summary>
        private readonly ILogger<MtEquipmentTypeRepository> _logger;
        ...
        public MtEquipmentTypeRepository(ILogger<MtEquipmentTypeRepository> logger, ITimeProvider timePrivder, DBPolly dbPolly, AppSettings appSettings)
        {
