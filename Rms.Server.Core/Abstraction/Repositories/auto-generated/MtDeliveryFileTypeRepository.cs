...
{
    /// <summary>
    /// MT_DELIVERY_FILE_TYPEテーブルのリポジトリ
    /// </summary>
    public partial class MtDeliveryFileTypeRepository : IMtDeliveryFileTypeRepository
    {
        /// <summary>ロガー</summary>
        private readonly ILogger<MtDeliveryFileTypeRepository> _logger;
        ...
        public MtDeliveryFileTypeRepository(ILogger<MtDeliveryFileTypeRepository> logger, ITimeProvider timePrivder, DBPolly dbPolly, AppSettings appSettings)
        {
        ...
        /// <summary>
        /// 引数に指定したMtDeliveryFileTypeをMT_DELIVERY_FILE_TYPEテーブルへ登録する
        /// </summary>
        /// <param name="inData">登録するデータ</param>
        /// <returns>処理結果</returns>
        public MtDeliveryFileType CreateMtDeliveryFileType(MtDeliveryFileType inData)
        {
            MtDeliveryFileType model = null;
            try
            {
                _logger.EnterJson("{0}", inData);
    
                Rms.Server.Core.DBAccessor.Models.MtDeliveryFileType entity = new Rms.Server.Core.DBAccessor.Models.MtDeliveryFileType(inData);
                ...
                _dbPolly.Execute(() =>
                {
                    ...
                    {
                        var dbdata = db.MtDeliveryFileType.Add(entity).Entity;
                        db.SaveChanges();
            ...
            {
                throw new RmsException("MT_DELIVERY_FILE_TYPEテーブルへのInsertに失敗しました。", e);
            }
            finally
            {
