...
namespace Rms.Server.Core.Abstraction.Repositories
{
    ...
    public partial class MtInstallTypeRepository : IMtInstallTypeRepository
    {
        ...
        /// <summary>
        /// 引数に指定したMtInstallTypeをMT_INSTALL_TYPEテーブルへ登録する
        /// </summary>
        /// <param name="inData">登録するデータ</param>
        /// <returns>処理結果</returns>
        public MtInstallType CreateMtInstallType(MtInstallType inData)
        {
            MtInstallType model = null;
            try
            {
                _logger.EnterJson("{0}", inData);
    
                Rms.Server.Core.DBAccessor.Models.MtInstallType entity = new Rms.Server.Core.DBAccessor.Models.MtInstallType(inData);
                ...
                _dbPolly.Execute(() =>
                {
                    ...
                    {
                        var dbdata = db.MtInstallType.Add(entity).Entity;
                        db.SaveChanges();
            ...
            {
                throw new RmsException("MT_INSTALL_TYPEテーブルへのInsertに失敗しました。", e);
            }
            finally
            {
