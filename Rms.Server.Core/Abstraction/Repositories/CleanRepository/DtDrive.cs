...
{
    public partial class DtDriveRepository : ICleanRepository
    {
        /// <summary>
        ...
        public int DeleteExceedsMonthsAllData(DateTime comparisonSourceDatetime)
        {
                    ...
                    using (DBAccessor.Models.RmsDbContext db = new DBAccessor.Models.RmsDbContext(_appSettings))
                    {
                        ...
                        .FromSql(
                            ...
                            Where
                                ...
                                and
                                tbl1.COLLECT_DATETIME <> (SELECT MAX(tbl2.COLLECT_DATETIME) FROM core.DT_DRIVE tbl2 Where tbl1.DEVICE_SID = tbl2.DEVICE_SID)",
                            CollectDatetime);

                        db.DtDrive.RemoveRange(targets);
            ...
            {
                throw new RmsException("DT_DRIVEテーブルのDeleteに失敗しました。", e);
            }
            finally
            {
