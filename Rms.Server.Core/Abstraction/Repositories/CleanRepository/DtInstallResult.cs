...
{
    public partial class DtInstallResultRepository : ICleanRepository
    {
        /// <summary>
        ...
        public int DeleteExceedsMonthsAllData(DateTime comparisonSourceDatetime)
        {
            ...
            try
            {
                ...
                _dbPolly.Execute(() =>
                {
                    using (DBAccessor.Models.RmsDbContext db = new DBAccessor.Models.RmsDbContext(_appSettings))
                    {
                        ...
                        var targets = db.DtInstallResult
                        .FromSql(
                            @"
                            Select
                                *
                            ...
                            Where
                                ...
                                and
                                tbl1.COLLECT_DATETIME <> (SELECT MAX(tbl2.COLLECT_DATETIME) FROM core.DT_INSTALL_RESULT tbl2 Where tbl1.DEVICE_SID = tbl2.DEVICE_SID)",
                            CollectDatetime);

                        db.DtInstallResult.RemoveRange(targets);
            ...
            {
                throw new RmsException("DT_INSTALL_RESULTテーブルのDeleteに失敗しました。", e);
            }
            finally
            {
