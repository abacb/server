...
{
    /// <summary>
    /// MT_INSTALL_TYPEテーブルのリポジトリ
    /// </summary>
    public partial class MtInstallTypeRepository : IMtInstallTypeRepository
    {
        /// <summary>ロガー</summary>
        private readonly ILogger<MtInstallTypeRepository> _logger;
