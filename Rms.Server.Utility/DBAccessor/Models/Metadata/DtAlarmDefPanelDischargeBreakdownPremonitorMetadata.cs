...
namespace Rms.Server.Utility.DBAccessor.Models
{
    ...
    /// <summary>
    /// DtAlarmDefPanelDischargeBreakdownPremonitorクラス
    /// </summary>
    [ModelMetadataType(typeof(DtAlarmDefPanelDischargeBreakdownPremonitorModelMetaData))]
    public partial class DtAlarmDefPanelDischargeBreakdownPremonitor
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DtAlarmDefPanelDischargeBreakdownPremonitor()
        {
        }
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="model">Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDischargeBreakdownPremonitorのインスタンス</param>
        public DtAlarmDefPanelDischargeBreakdownPremonitor(Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDischargeBreakdownPremonitor model)
        {
            this.Sid = model.Sid;
        ...
        /// <summary>
        /// このインスタンスの各プロパティに、引数に指定されたDtAlarmDefPanelDischargeBreakdownPremonitorのプロパティの値をコピーする
        /// </summary>
        /// <param name="entity">コピー元のDtAlarmDefPanelDischargeBreakdownPremonitor</param>
        public void CopyFrom(DtAlarmDefPanelDischargeBreakdownPremonitor entity)
        {
            this.Sid = entity.Sid;
        ...
        /// <summary>
        /// このインスタンスを、それと同等なRms.Server.Utility.Utility.Models.DtAlarmDefPanelDischargeBreakdownPremonitor型に変換する。
        /// </summary>
        /// <returns></returns>
        public Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDischargeBreakdownPremonitor ToModel()
        {
            Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDischargeBreakdownPremonitor model = new Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDischargeBreakdownPremonitor();
            model.Sid = this.Sid;
    ...
    /// <summary>
    /// DtAlarmDefPanelDischargeBreakdownPremonitorのメタデータクラス
    /// </summary>
    public  class DtAlarmDefPanelDischargeBreakdownPremonitorModelMetaData
    {
        [Key]
