...
namespace Rms.Server.Utility.DBAccessor.Models
{
    ...
    /// <summary>
    /// DtAlarmDefFailurePremonitorクラス
    /// </summary>
    [ModelMetadataType(typeof(DtAlarmDefFailurePremonitorModelMetaData))]
    public partial class DtAlarmDefFailurePremonitor
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DtAlarmDefFailurePremonitor()
        {
        }
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="model">Rms.Server.Utility.Utility.Models.DtAlarmDefFailurePremonitorのインスタンス</param>
        public DtAlarmDefFailurePremonitor(Rms.Server.Utility.Utility.Models.DtAlarmDefFailurePremonitor model)
        {
            this.Sid = model.Sid;
        ...
        /// <summary>
        /// このインスタンスの各プロパティに、引数に指定されたDtAlarmDefFailurePremonitorのプロパティの値をコピーする
        /// </summary>
        /// <param name="entity">コピー元のDtAlarmDefFailurePremonitor</param>
        public void CopyFrom(DtAlarmDefFailurePremonitor entity)
        {
            this.Sid = entity.Sid;
        ...
        /// <summary>
        /// このインスタンスを、それと同等なRms.Server.Utility.Utility.Models.DtAlarmDefFailurePremonitor型に変換する。
        /// </summary>
        /// <returns></returns>
        public Rms.Server.Utility.Utility.Models.DtAlarmDefFailurePremonitor ToModel()
        {
            Rms.Server.Utility.Utility.Models.DtAlarmDefFailurePremonitor model = new Rms.Server.Utility.Utility.Models.DtAlarmDefFailurePremonitor();
            model.Sid = this.Sid;
    ...
    /// <summary>
    /// DtAlarmDefFailurePremonitorのメタデータクラス
    /// </summary>
    public  class DtAlarmDefFailurePremonitorModelMetaData
    {
        [Key]
