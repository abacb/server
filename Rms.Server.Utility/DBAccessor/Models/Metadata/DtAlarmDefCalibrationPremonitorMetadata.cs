...
namespace Rms.Server.Utility.DBAccessor.Models
{
    ...
    /// <summary>
    /// DtAlarmDefCalibrationPremonitorクラス
    /// </summary>
    [ModelMetadataType(typeof(DtAlarmDefCalibrationPremonitorModelMetaData))]
    public partial class DtAlarmDefCalibrationPremonitor
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DtAlarmDefCalibrationPremonitor()
        {
        }
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="model">Rms.Server.Utility.Utility.Models.DtAlarmDefCalibrationPremonitorのインスタンス</param>
        public DtAlarmDefCalibrationPremonitor(Rms.Server.Utility.Utility.Models.DtAlarmDefCalibrationPremonitor model)
        {
            this.Sid = model.Sid;
        ...
        /// <summary>
        /// このインスタンスの各プロパティに、引数に指定されたDtAlarmDefCalibrationPremonitorのプロパティの値をコピーする
        /// </summary>
        /// <param name="entity">コピー元のDtAlarmDefCalibrationPremonitor</param>
        public void CopyFrom(DtAlarmDefCalibrationPremonitor entity)
        {
            this.Sid = entity.Sid;
        ...
        /// <summary>
        /// このインスタンスを、それと同等なRms.Server.Utility.Utility.Models.DtAlarmDefCalibrationPremonitor型に変換する。
        /// </summary>
        /// <returns></returns>
        public Rms.Server.Utility.Utility.Models.DtAlarmDefCalibrationPremonitor ToModel()
        {
            Rms.Server.Utility.Utility.Models.DtAlarmDefCalibrationPremonitor model = new Rms.Server.Utility.Utility.Models.DtAlarmDefCalibrationPremonitor();
            model.Sid = this.Sid;
    ...
    /// <summary>
    /// DtAlarmDefCalibrationPremonitorのメタデータクラス
    /// </summary>
    public  class DtAlarmDefCalibrationPremonitorModelMetaData
    {
        [Key]
