...
namespace Rms.Server.Utility.DBAccessor.Models
{
    ...
    /// <summary>
    /// DtAlarmDefTemperatureSensorLogMonitorクラス
    /// </summary>
    [ModelMetadataType(typeof(DtAlarmDefTemperatureSensorLogMonitorModelMetaData))]
    public partial class DtAlarmDefTemperatureSensorLogMonitor
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DtAlarmDefTemperatureSensorLogMonitor()
        {
        }
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="model">Rms.Server.Utility.Utility.Models.DtAlarmDefTemperatureSensorLogMonitorのインスタンス</param>
        public DtAlarmDefTemperatureSensorLogMonitor(Rms.Server.Utility.Utility.Models.DtAlarmDefTemperatureSensorLogMonitor model)
        {
            this.Sid = model.Sid;
        ...
        /// <summary>
        /// このインスタンスの各プロパティに、引数に指定されたDtAlarmDefTemperatureSensorLogMonitorのプロパティの値をコピーする
        /// </summary>
        /// <param name="entity">コピー元のDtAlarmDefTemperatureSensorLogMonitor</param>
        public void CopyFrom(DtAlarmDefTemperatureSensorLogMonitor entity)
        {
            this.Sid = entity.Sid;
        ...
        /// <summary>
        /// このインスタンスを、それと同等なRms.Server.Utility.Utility.Models.DtAlarmDefTemperatureSensorLogMonitor型に変換する。
        /// </summary>
        /// <returns></returns>
        public Rms.Server.Utility.Utility.Models.DtAlarmDefTemperatureSensorLogMonitor ToModel()
        {
            Rms.Server.Utility.Utility.Models.DtAlarmDefTemperatureSensorLogMonitor model = new Rms.Server.Utility.Utility.Models.DtAlarmDefTemperatureSensorLogMonitor();
            model.Sid = this.Sid;
    ...
    /// <summary>
    /// DtAlarmDefTemperatureSensorLogMonitorのメタデータクラス
    /// </summary>
    public  class DtAlarmDefTemperatureSensorLogMonitorModelMetaData
    {
        [Key]
