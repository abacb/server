...
namespace Rms.Server.Utility.DBAccessor.Models
{
    ...
    /// <summary>
    /// DtAlarmDefPanelDefectPremonitorクラス
    /// </summary>
    [ModelMetadataType(typeof(DtAlarmDefPanelDefectPremonitorModelMetaData))]
    public partial class DtAlarmDefPanelDefectPremonitor
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DtAlarmDefPanelDefectPremonitor()
        {
        }
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="model">Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDefectPremonitorのインスタンス</param>
        public DtAlarmDefPanelDefectPremonitor(Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDefectPremonitor model)
        {
            this.Sid = model.Sid;
        ...
        /// <summary>
        /// このインスタンスの各プロパティに、引数に指定されたDtAlarmDefPanelDefectPremonitorのプロパティの値をコピーする
        /// </summary>
        /// <param name="entity">コピー元のDtAlarmDefPanelDefectPremonitor</param>
        public void CopyFrom(DtAlarmDefPanelDefectPremonitor entity)
        {
            this.Sid = entity.Sid;
        ...
        /// <summary>
        /// このインスタンスを、それと同等なRms.Server.Utility.Utility.Models.DtAlarmDefPanelDefectPremonitor型に変換する。
        /// </summary>
        /// <returns></returns>
        public Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDefectPremonitor ToModel()
        {
            Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDefectPremonitor model = new Rms.Server.Utility.Utility.Models.DtAlarmDefPanelDefectPremonitor();
            model.Sid = this.Sid;
    ...
    /// <summary>
    /// DtAlarmDefPanelDefectPremonitorのメタデータクラス
    /// </summary>
    public  class DtAlarmDefPanelDefectPremonitorModelMetaData
    {
        [Key]
