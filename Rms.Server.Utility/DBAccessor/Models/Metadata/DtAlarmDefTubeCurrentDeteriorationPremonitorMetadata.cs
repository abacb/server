...
namespace Rms.Server.Utility.DBAccessor.Models
{
    ...
    /// <summary>
    /// DtAlarmDefTubeCurrentDeteriorationPremonitorクラス
    /// </summary>
    [ModelMetadataType(typeof(DtAlarmDefTubeCurrentDeteriorationPremonitorModelMetaData))]
    public partial class DtAlarmDefTubeCurrentDeteriorationPremonitor
    {
        /// <summary>
        /// コンストラクタ
        /// </summary>
        public DtAlarmDefTubeCurrentDeteriorationPremonitor()
        {
        }
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="model">Rms.Server.Utility.Utility.Models.DtAlarmDefTubeCurrentDeteriorationPremonitorのインスタンス</param>
        public DtAlarmDefTubeCurrentDeteriorationPremonitor(Rms.Server.Utility.Utility.Models.DtAlarmDefTubeCurrentDeteriorationPremonitor model)
        {
            this.Sid = model.Sid;
        ...
        /// <summary>
        /// このインスタンスの各プロパティに、引数に指定されたDtAlarmDefTubeCurrentDeteriorationPremonitorのプロパティの値をコピーする
        /// </summary>
        /// <param name="entity">コピー元のDtAlarmDefTubeCurrentDeteriorationPremonitor</param>
        public void CopyFrom(DtAlarmDefTubeCurrentDeteriorationPremonitor entity)
        {
            this.Sid = entity.Sid;
        ...
        /// <summary>
        /// このインスタンスを、それと同等なRms.Server.Utility.Utility.Models.DtAlarmDefTubeCurrentDeteriorationPremonitor型に変換する。
        /// </summary>
        /// <returns></returns>
        public Rms.Server.Utility.Utility.Models.DtAlarmDefTubeCurrentDeteriorationPremonitor ToModel()
        {
            Rms.Server.Utility.Utility.Models.DtAlarmDefTubeCurrentDeteriorationPremonitor model = new Rms.Server.Utility.Utility.Models.DtAlarmDefTubeCurrentDeteriorationPremonitor();
            model.Sid = this.Sid;
    ...
    /// <summary>
    /// DtAlarmDefTubeCurrentDeteriorationPremonitorのメタデータクラス
    /// </summary>
    public  class DtAlarmDefTubeCurrentDeteriorationPremonitorModelMetaData
    {
        [Key]
