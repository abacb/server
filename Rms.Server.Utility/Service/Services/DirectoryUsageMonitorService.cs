...
{
    /// <summary>
    /// DirectoryUsasgeMonitorService
    /// </summary>
    public class DirectoryUsageMonitorService : IDirectoryUsageMonitorService
    {
        /// <summary>
        /// 設定
        /// </summary>
        ...
        /// <summary>
        /// ディレクトリ使用量監視アラーム定義リポジトリ
        /// </summary>
        private readonly IDtAlarmDefDirectoryUsageMonitorRepository _dtAlarmDefDirectoryUsageMonitorRepository;
        ...
        /// <param name="dtAlarmDefDirectoryUsageMonitorRepository">ディレクトリ使用量監視アラーム定義リポジトリ</param>
        /// <param name="queueRepository">Queueリポジトリ</param>
        /// <param name="failureRepository">Failureストレージリポジトリ</param>
        public DirectoryUsageMonitorService(
            UtilityAppSettings settings,
            ILogger<DirectoryUsageMonitorService> logger,
            ITimeProvider timeProvider,
            IDtAlarmDefDirectoryUsageMonitorRepository dtAlarmDefDirectoryUsageMonitorRepository,
            ...
            IFailureRepository failureRepository)
        {
            ...
            Assert.IfNull(dtAlarmDefDirectoryUsageMonitorRepository);
            ...
            _dtAlarmDefDirectoryUsageMonitorRepository = dtAlarmDefDirectoryUsageMonitorRepository;
        ...
        public void UpdateToFailureStorage(string messageSchemaId, string messageId, string message)
        {
            ...
            catch (RmsException e)
            {
                ...
                _logger.Error(e, nameof(Resources.UT_DUM_DUM_008), new object[] { messageId, message });
            }
            finally
            {
                _logger.Leave();
