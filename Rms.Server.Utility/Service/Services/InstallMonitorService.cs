...
namespace Rms.Server.Utility.Service.Services
{
    ...
    /// </summary>
    public class InstallMonitorService : IInstallMonitorService
    {
        /// <summary>
        /// 設定
        /// </summary>
        ...
        /// 適用結果監視アラーム定義リポジトリ
        /// </summary>
        private readonly IDtAlarmDefInstallResultMonitorRepository _dtAlarmDefInstallResultMonitorRepository;
        ...
        /// <param name="dtAlarmDefInstallResultMonitorRepository">適用結果アラーム定義リポジトリ</param>
        /// <param name="queueRepository">Queueリポジトリ</param>
        /// <param name="failureRepository">Failureストレージリポジトリ</param>
        public InstallMonitorService(
            UtilityAppSettings settings,
            ILogger<InstallMonitorService> logger,
            ITimeProvider timeProvider,
            IDtAlarmDefInstallResultMonitorRepository dtAlarmDefInstallResultMonitorRepository,
            ...
            IFailureRepository failureRepository)
        {
            ...
            Assert.IfNull(dtAlarmDefInstallResultMonitorRepository);
            ...
            _dtAlarmDefInstallResultMonitorRepository = dtAlarmDefInstallResultMonitorRepository;
        ...
        public void UpdateToFailureStorage(string messageSchemaId, string messageId, string message)
        {
            ...
            catch (RmsException e)
            {
                ...
                _logger.Error(e, nameof(Resources.UT_INM_INM_008), new object[] { messageId, message });
            }
            finally
            {
                _logger.Leave();
