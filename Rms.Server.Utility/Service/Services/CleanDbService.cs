...
namespace Rms.Server.Utility.Service.Services
{
    ...
    public class CleanDbService : Core.Service.Services.CleanDbService
    {
        ...
        protected override string RepositoryNameFormat
        {
            get
            {
                return "Rms.Server.Utility.Abstraction.Repositories.{0}Repository, Rms.Server.Utility.Abstraction";
            }
        }
        ...
        {
            Utility.Extensions.LoggerExtensions.Error(logger, ex, nameof(Utility.Properties.Resources.UT_DBC_DBC_001), callerMemberName, callerFilePath, callerLineNumber);
        }
        ...
        {
            Utility.Extensions.LoggerExtensions.Error(logger, ex, nameof(Utility.Properties.Resources.UT_DBC_DBC_002), args, callerMemberName, callerFilePath, callerLineNumber);
        }
        ...
        {
            Utility.Extensions.LoggerExtensions.Error(logger, ex, nameof(Utility.Properties.Resources.UT_DBC_DBC_003), args, callerMemberName, callerFilePath, callerLineNumber);
        }
        ...
        {
            Utility.Extensions.LoggerExtensions.Info(logger, nameof(Utility.Properties.Resources.UT_DBC_DBC_004), args, callerMemberName, callerFilePath, callerLineNumber);
        }
    }
}
